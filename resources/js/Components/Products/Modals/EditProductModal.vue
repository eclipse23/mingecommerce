                              ...
                              <div class="modal-body p-5 w-full h-full overflow-y-auto">
                                  <div class="space-y-8 divide-y divide-gray-200">
                                            ...
                                            <div class="grid grid-cols-5 gap-2 mt-4">
                                                <div>
                                                    ...
                                                    <div v-else>
                                                        ...
                                                        <div class="mt-2 flex w-full items-center justify-center bg-grey-lighter">
                                                            <label @click="removeImage('one')" class="w-64 flex flex-col items-center px-2 py-2 bg-red-500 text-dark rounded-lg shadow-lg tracking-wide uppercase border border-blue cursor-pointer hover:bg-red-300 hover:text-gray-300">
                                                ...
                                                <div>
                                                    ...
                                                    <div v-else>
                                                        ...
                                                        <div class="mt-2 flex w-full items-center justify-center bg-grey-lighter">
                                                            <label @click="removeImage('two')" class="w-64 flex flex-col items-center px-2 py-2 bg-red-500 text-dark rounded-lg shadow-lg tracking-wide uppercase border border-blue cursor-pointer hover:bg-red-300 hover:text-gray-300">
                                                                <span class="text-xs leading-normal">Remove</span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                ...
                                                <div>
                                                    ...
                                                    <div v-else>
                                                        ...
                                                        <div class="mt-2 flex w-full items-center justify-center bg-grey-lighter">
                                                            <label @click="removeImage('three')" class="w-64 flex flex-col items-center px-2 py-2 bg-red-500 text-dark rounded-lg shadow-lg tracking-wide uppercase border border-blue cursor-pointer hover:bg-red-300 hover:text-gray-300">
                                                                <span class="text-xs leading-normal">Remove</span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                ...
                                                <div>
                                                    ...
                                                    <div v-else>
                                                        ...
                                                        <div class="mt-2 flex w-full items-center justify-center bg-grey-lighter">
                                                            <label @click="removeImage('four')" class="w-64 flex flex-col items-center px-2 py-2 bg-red-500 text-dark rounded-lg shadow-lg tracking-wide uppercase border border-blue cursor-pointer hover:bg-red-300 hover:text-gray-300">
                                                                <span class="text-xs leading-normal">Remove</span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                ...
                                                <div>
                                                    ...
                                                    <div v-else>
                                                        ...
                                                        <div class="mt-2 flex w-full items-center justify-center bg-grey-lighter">
                                                            <label @click="removeImage('five')" class="w-64 flex flex-col items-center px-2 py-2 bg-red-500 text-dark rounded-lg shadow-lg tracking-wide uppercase border border-blue cursor-pointer hover:bg-red-300 hover:text-gray-300">
                                                                <span class="text-xs leading-normal">Remove</span>
                                                            </label>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="pt-5">
                                        ...
                                        <button @click="updateProduct()" class="ml-3 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-orange-600 hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500">
                                            Save
                                        </button>
                                        </div>
                                    </div>
...
export default {
  ...
  methods: {
    ...
    fillForm() {
        ...
        this.form.hot_deal = this.product.hot_deal == 1 ? true : false
        this.form.new_arrival = this.product.new_arrival == 1 ? true : false
        for(var ctr = 0; ctr < this.product.images.length; ctr++) {
            if(this.product.images[ctr] != "") {
                if(ctr == 0) {
                    this.images.pictureOneUrl = this.product.images[ctr]
                }
                if(ctr == 1) {
                    this.images.pictureTwoUrl = this.product.images[ctr]
                }
                if(ctr == 2) {
                    this.images.pictureThreeUrl = this.product.images[ctr]
                }
                if(ctr == 3) {
                    this.images.pictureFourUrl = this.product.images[ctr]
                }
                if(ctr == 4) {
                    this.images.pictureFiveUrl = this.product.images[ctr]
                }
            }
        }
    },
    ...
    pictureThreeChange(e) {
        ...
        this.updateImage('three')
    },
    pictureFourChange(e) {
        this.images.pictureFour= event.target.files[0]
        this.images.pictureFourUrl = URL.createObjectURL(this.images.pictureFour);
        this.updateImage('four')
    },
    pictureFiveChange(e) {
        this.images.pictureFive= event.target.files[0]
        this.images.pictureFiveUrl = URL.createObjectURL(this.images.pictureFive);
        this.updateImage('five')
    },
    async updateImage(order) {
        let formData = new FormData();

        if(order == 'one') {
            formData.append('image', this.images.pictureOne);
        }
        if(order == 'two') {
            formData.append('image', this.images.pictureTwo);
        }
        if(order == 'three') {
            formData.append('image', this.images.pictureThree);
        }
        if(order == 'four') {
            formData.append('image', this.images.pictureFour);
        }
        if(order == 'five') {
            formData.append('image', this.images.pictureFive);
        }
        formData.append('order', order);
        formData.append('id', this.product.id);
        await axios.post(`/product-image-update`, formData)
        .then(response => {
            console.log(response)
        })
    },
    async removeImage(order) {
        this.isLoading = true
        await axios.put(`/product-image-delete/${this.product.id}`, {order: order})
        .then(response => {
            console.log(response)
            if(order == 'one') {
