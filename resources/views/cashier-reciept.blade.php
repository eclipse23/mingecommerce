        ...
        <td>
          ...
          <div style="width: 100%" class="page" style="line-height: 3;">
            <table style="width: 100%" class="table-items">
                <tr class='tr-items'>
                  <th class="th-items">Qty</th>
                  <th class="th-items">Unit</th>
                  <th class="th-items">Product Name</th>
                  <th class="th-items">Unit Price</th>
                  <th class="th-items">Amount</th>
                </tr>
                @php $total = 0;@endphp
                @foreach ($items as $item)
                  <tr class='tr-items'>
                    <td class="td-items">{{ $item->quantity }}</td>
                    <td class="td-items"></td>
