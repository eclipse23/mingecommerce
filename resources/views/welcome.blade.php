...
<<<<<<< HEAD
            <a href="/products/all-products" class="mt-8 w-full block bg-orange-600 border border-transparent rounded-md py-3 px-8 text-base font-bold text-white hover:bg-indigo-100 sm:w-auto">View All Products</a>
=======
